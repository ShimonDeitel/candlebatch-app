...
struct EditItemView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section {
                TextField("Batch Name", text: $draft.title)
                    .accessibilityIdentifier("field_title")
                TextField("Wax Type", text: $draft.waxType, axis: .vertical)
                    .accessibilityIdentifier("field_waxType")
                TextField("Fragrance %", text: $draft.fragrancePct, axis: .vertical)
                    .accessibilityIdentifier("field_fragrancePct")
                TextField("Wick Size", text: $draft.wickSize, axis: .vertical)
                    .accessibilityIdentifier("field_wickSize")
